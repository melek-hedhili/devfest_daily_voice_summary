    ...
    <View style={styles.container}>
      ...
      <View style={styles.itemContainer}>
        <View style={styles.card(original.backgroundColor)}>
          ...
          <Text style={{color: '#767676'}}>{original.title}</Text>
          <Text style={{color: '#767676'}}> {original.date}</Text>
        </View>
        ...
        <View style={styles.card(compat?.backgroundColor)}>
          ...
          <Text style={{color: '#767676'}}>{compat?.title}</Text>
          <Text style={{color: '#767676'}}>{compat?.date}</Text>
        </View>
      </View>
    </View>
  );
